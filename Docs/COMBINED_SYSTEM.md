...
The **RCE Proxy Worker** ([RCE-Proxy/worker.js](../RCE-Proxy/worker.js)) routes traffic dynamically based on paths and headers:
...
Configure these in [RCE-Proxy/wrangler.toml](../RCE-Proxy/wrangler.toml):

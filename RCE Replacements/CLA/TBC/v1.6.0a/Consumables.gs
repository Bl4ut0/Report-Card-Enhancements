function populateBuffConsumables() {
  ...
  SpreadsheetApp.flush(); // Flush deletions before copying the new sheet
  ...
  var allFightsData = wclFetchFights_(api_key, logId, {
    lang: lang,
  ...
  // Wrapper Replacement for people tracked casts table
